       ...
       <div class="row d-flex flex-row-reverse">
        ...
        <div class="col-lg-9 col-md-8 col-sm-12">
              ...
              <div class="col-md-12 col-lg-4">
                ...
                <!--  <li><i class="ti-check-box"></i> <span class="label">Assessments</span> <span class="value">Yes</span></li>-->
                 <li><i class="ti-time"></i> <span class="label">Duration</span> <span class="value">
                  ...
                  @php
          $enroll= App\Models\UserEnrollment::where('course_id',$course->id)->count();
          ...
          @endphp
                    ...
                    <li><i class="fa-solid fa-dice-d20"></i> <span class="label">Total Enrollments: </span> <span class="value">{{$enroll}}</span></li>
              </ul>
              </div>
          ...
          <div class="m-b30" id="curriculum">
            <h4>Curriculum</h4>
              ...
              <section id="accordion-hover">
                ...
                <a href="https://www.globalskills.com.bd/itil4" class="btn btn success">Play FlashCard Games</a>
