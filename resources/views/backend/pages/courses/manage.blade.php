            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <span class="font-weight-bold">{{Str::limit($row->course_title,12)}}</span>
                </td>
                <td>
                ...
                <td>{{Str::limit( $row->preview_id,10) }}</td>
                ...
                <td>
                  <a href="/admin/home/courses/course_overviews/{{$row->id}}"><i class="fas fa-eye"></i></a>
