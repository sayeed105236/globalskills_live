 ...
 <head>
     ...
     @font-face {
         ...
         src: url('https://globalskills.com.bd/public/font/ACaslonPro-Italic.otf') format('truetype');;
     }
     @font-face {
         font-family: mySecondFont;
         /*src: url("public/font/MonotypeCorsiva_Regular.ttf");*/
         src: url('https://globalskills.com.bd/public/font/MonotypeCorsiva_Regular.ttf') format('truetype');;
     }
        ...
        span.cls_007{font-family:Times,serif;font-size:24.6px;color:rgb(43,42,41);font-weight:bold;font-style:normal;text-decoration: none}
 ...
 <div style="position:absolute;left:37%;top:266.12px" class="cls_006"><span class="cls_006">has completed the training course of :</span></div>
 ...
 <div style="position:absolute;left: 170.06px;top: 550.77px;" class="cls_011"><span class="cls_011">Certificate no: 202201{{$evolution->course->id}}{{Auth::user()->id}}{{$evolution->course->id}}</span></div>
