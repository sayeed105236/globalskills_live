  ...
  <div class="pt-exebar">
    <div class="container">
      ...
      <div class="col-lg-4 col-md-12 col-sm-12 footer-col-4">
                    <div class="widget">
                        <h5 class="footer-title">ITIL® / PRINCE2® are registered trade marks of AXELOS Limited, The Swirl logo<span>&#8482;</span> is a trademark of AXELOS
                            Limited, Copyright &copy; AXELOS Limited, used under permission of AXELOS Limited, all right reserved.</h5>
            ...
            <div class="widget footer_widget">
              ...
              <ul>
                ...
                <li><a href="{{route('all-blogs')}}">Blog</a></li>
                  <li><a href="{{route('certificate-request')}}">Letter of Attendance
                  /<br>Certificate</a></li>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 text-center"> <a target="_blank" href="https://www.globalskills.com.bd/">An Inhouse Product of Global Skills Development Agency</a></div>
            </div>
        </div>
    </div>
</footer>
