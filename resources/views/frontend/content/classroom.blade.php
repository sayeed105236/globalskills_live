<div class="section-area section-sp2 popular-courses-bx">
    ...
    <div> <h2 class="text-center"><button class="btn btn-primary btn-sm" href="#" data-toggle="modal" data-target="#CalenderModal"><i class="fa fa-calendar-alt"></i> Training Calender</button>
          </h2>
            @include('frontend.modals.calendermodal')</div>
    <div class="row">
      ...
      <div class="item" >
        <div class="cours-bx">
          <div class="action-box">
            <a href="{{ url('home/classroom/course_details/'.$row->id.'/'.$row->classroom_slug) }}"><img src="{{asset("storage/Classroom courses/$row->classroom_course_image")}}" alt="{{$row->classroom_course_title}}"></a>
