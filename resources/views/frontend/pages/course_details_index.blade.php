                    ...
                    <div class="row d-flex flex-row-reverse">
                        <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
                            <div class="course-detail-bx">
                                <img src="{{ asset($mocktest->image) }}" alt="" style="height: 150px; width: 200px;">
                                <?php
                                $enrolled= App\Models\UserEnrollment::where('user_id',Auth::id())->where('mocktest_id',$mocktest->id)->first();
                                ...
                                @if($enrolled)
                                  <div class="course-price">
                                    <div class="text-center mt-2">
                                        <a href="{{ url('mocktest/topics/view/'.$mocktest->id) }}" class="btn">Already Enrolled</a>
                                    </div>
                                </div>
                                @else
                                <div class="course-price">
                                    <del>{{ $mocktest->regular_price }}৳</del>
                                    <h4 class="price">{{ $mocktest->discount_price }}৳</h4>
                                </div>
                                <div class="course-buy-now text-center mb-1">
                                  <form class="hidden" action="{{route('add-carts')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="mocktest_id" value="{{$mocktest->id}}">
                                ...
                                {{-- <div class="teacher-bx">
                                    <div class="teacher-info">
                                        <div class="teacher-thumb">
                                            <img src="{{ asset($mocktest->image) }}" alt="" />
                                        </div>
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-12">
                            <div class="courses-post">
                                <div class="ttr-post-media media-effect">
                                    ...
                                    <img src="{{ asset($mocktest->image) }}" alt="" style="height: 400px; width: 800px;"/>
                                ...
                                <div class="ttr-post-info">
                                    ...
                                    <div class="ttr-post-title ">
                                        ...
                                        <h2 class="post-title mb-4">{{ $mocktest->mock_category }}</h2>
                                    </div>
                            ...
                            <div class="courese-overview" id="overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-8">
                                        ...
                                        <h5 class="m-b5">Mocktest Description</h5>
                                        <p>{!!$mocktest->description!!}</p>


                                        <h5 class="m-b5">Exam Format</h5>
                                        <ul class="list-checked primary">
                                            <li>{!!$mocktest->exam_format!!}</li>
