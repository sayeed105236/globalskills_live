...
<div class="breadcrumb-row">
  <div class="container">
    <ul class="list-inline">
      ...
      <li>Request for Letter of Attendance/ Certificate</li>
    </ul>
  </div>
</div>
<!-- Breadcrumb row END -->
    ...
    <div class="page-banner contact-page section-sp2">
      ...
      <div class="col-lg-7 col-md-7">
          ...
          <div class="heading-bx left">
            <h2 class="title-head">Request for Letter of Attendance/<span>Certificate</span></h2>

          </div>
          <div class="row">
            <div class="col">
              <a class="btn btn-primary float-right" data-toggle="modal" data-target="#CertificateRequest" href="#">Request For Letter of Attendance/Certificate</a>
