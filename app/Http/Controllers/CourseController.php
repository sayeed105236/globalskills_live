...
class CourseController extends Controller
{
  ...
  public function course_details_frontend($id,$slug)
  {
    ...
    return view('/backend/pages/courses.course_details_index',compact('course_details','main_categories','timer','course_categories','course','enrolled','courseReview','avgRating','trainer','data'));
  }
